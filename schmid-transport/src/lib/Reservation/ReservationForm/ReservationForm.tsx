...
export const ReservationForm = ({isFormOpen, setIsFormOpen}: ReservationFormProps): JSX.Element => {
    ...
    //todo: move out
    const createErrorMessage = (formDataType: FromDataType, maxLength: number): string => {
                ...
                <DataLoader apiState={test} content={<></>} renderSuccess={
                    <Container maxWidth={"sm"}>
                        <Paper elevation={20}
                            ...
                            <DataLoader
                                renderSuccess={
                                    <Box flexDirection="column" style={{marginTop: "8rem"}}>
                                        <Container maxWidth={"sm"}>
                                                ...
                                                <Container maxWidth={"sm"}>
                                                    <Box display="flex" flexDirection={"column"}>
                                                        <TextField
                                                            ...
                                                            helperText={
                                                                createErrorMessage(FromDataType.NAME, 20)
                                                            }
                                                        />
                                                        <TextField
                                                            style={inputStyle}
                                                            ...
                                                            helperText={
                                                                createErrorMessage(FromDataType.SURNAME, 30)}
                                                        />
                                                        <TextField
                                                            style={inputStyle}
                                                            label="email"
                                                            ...
                                                            helperText={
                                                                createErrorMessage(FromDataType.EMAIL, 40)}
                                                        />
                                                        <TextField
                                                            style={inputStyle}
                                                            defaultValue={"+420"}
                                                            ...
                                                            helperText={createErrorMessage(FromDataType.PHONE_NUMBER, 12)}
                                                        />
